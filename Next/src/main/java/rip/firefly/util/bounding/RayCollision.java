...
public class RayCollision implements RCollisionBox {
    ...
    public boolean isCollided(RCollisionBox other) {
        if (other instanceof RayCollision) {
            ...
            List<SRayCBox> boxes = new ArrayList<>();
...
//    public List<RCollisionBox> boxesOnRay(World world, double distance) {
...
//    }
    ...
    @Override
    public void downCast(List<SRayCBox> list) {/*Do Nothing, Ray cannot be down-casted*/}
    ...
    public static double distance(RayCollision ray, SRayCBox box) {
    ...
    public static double distance(RayCollision ray, SRayCBox box, boolean exact, double range) {
    ...
    public static double distance(RayCollision ray, SRayCBox box, boolean exact) {
        return distance(ray, box, exact, 0.12);
    }

    public static boolean intersect(RayCollision ray, SRayCBox aab) {
...
//                    result.y = tFar;
    ...
    // Result X = near
    // Result Y = far
    public static boolean intersect(RayCollision ray, SRayCBox aab, Tuple<Double,Double> result) {
        double invDirX = 1.0D / ray.directionX;
        double invDirY = 1.0D / ray.directionY;
        double invDirZ = 1.0D / ray.directionZ;
        double tFar;
    ...
    public Vector collisionPoint(SRayCBox box) {
