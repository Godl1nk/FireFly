...
public class AABB {
    ...
    private AABB(Entity entity, boolean reach) {
        this.min = entity.getLocation().toVector().add(new Vector(-0.3, 0, -0.3));
        this.max = entity.getLocation().toVector().add(new Vector(0.3, 1.8, 0.3));
    }

    private Vector getMin(Player player) {
        return player.getLocation().toVector().add(new Vector(-0.3 + HitboxExpansion.PLAYER.getExpansion() + 0.3, 0 + HitboxExpansion.PLAYER.getExpansion() + 0.3, -0.3 + HitboxExpansion.PLAYER.getExpansion() + 0.3));
    }

    private Vector getMax(Player player) {
        return player.getLocation().toVector().add(new Vector(0.3 + HitboxExpansion.PLAYER.getExpansion() + 0.3, 1.8 + HitboxExpansion.PLAYER.getExpansion() + 0.3, 0.3 + HitboxExpansion.PLAYER.getExpansion() + 0.3));
    }
    ...
    public static AABB fromR(Entity entity) {
        return new AABB(entity, true);
    }
