...
public class WrapperPlayServerNamedEntitySpawn extends AbstractPacket {
	...
	public double getX() {
		return (double) (this.handle.getIntegers().read(0) / 32.0D);
	}

	public void setX(double value) {
		this.handle.getIntegers().write(0, (int) (value * 32.0D));
	}

	public double getY() {
		return (double) (this.handle.getIntegers().read(1) / 32.0D);
	}

	public void setY(double value) {
		this.handle.getIntegers().write(1, (int) (value * 32.0D));
	}

	public double getZ() {
		return (double) (this.handle.getIntegers().read(2) / 32.0D);
	}

	public void setZ(double value) {
		this.handle.getIntegers().write(2, (int) (value * 32.0D));
	}
